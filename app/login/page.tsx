    ...
    return (
        <div className="w-full max-w-md bg-[#171916] rounded-[28px] p-8 shadow-[0_4px_12px_5px_rgba(0,0,0,0.25)]">
            <div className="flex flex-col items-center gap-2 mb-8">
                ...
                <h1 className="text-2xl font-manrope font-bold text-white">Bem-vindo de volta</h1>
                <p className="text-[#e8ebe6] opacity-60 font-inter text-sm">Faça login para acessar sua conta</p>
            </div>
            ...
            <form ref={formRef} className="flex flex-col gap-4">
                ...
                <button formAction={login} className="w-full bg-[#9fe870] hover:bg-[#8fd860] text-[#163300] font-semibold py-3 rounded-xl transition-colors font-inter mt-2">
                    Entrar
                </button>
            </form>
