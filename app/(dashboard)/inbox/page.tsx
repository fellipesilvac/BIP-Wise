    ...
    return (
        <div className="max-w-3xl mx-auto pb-20 font-inter">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-2xl font-bold text-[#e8ebe6]">Caixa de entrada</h1>
            </div>
            ...
            <div className="bg-[#171916] border border-[#ffffff08] rounded-2xl p-12 flex flex-col items-center justify-center text-center space-y-6">
                ...
                <div className="space-y-2 max-w-md">
                    <h2 className="text-xl font-bold text-[#e8ebe6]">Suas mensagens</h2>
                    <p className="text-[#a8aaac] leading-relaxed">
                        Fique de olho! Aqui você receberá notificações importantes, novidades da plataforma e comunicados oficiais.
                    </p>
                </div>
