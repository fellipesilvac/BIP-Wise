    ...
    return (
        <div className="max-w-3xl mx-auto pb-20 font-inter">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <h1 className="text-2xl font-bold text-[#e8ebe6]">Políticas de Privacidade</h1>
            </div>
            ...
            <div className="bg-[#171916] border border-[#ffffff08] rounded-2xl p-12 flex flex-col items-center justify-center text-center space-y-6">
                ...
                <div className="space-y-2 max-w-md">
                    <h2 className="text-xl font-bold text-[#e8ebe6]">Documentação em atualização</h2>
                    <p className="text-[#a8aaac] leading-relaxed">
                        Estamos revisando nossos termos e políticas de privacidade para garantir total transparência e segurança com seus dados.
                        O documento detalhado estará disponível aqui em breve.
                    </p>
                </div>
